...
public class JanelaHospitaisConstituicao extends javax.swing.JFrame {
    private Sistema sistema;
    
    public JanelaHospitaisConstituicao(Sistema sistema) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Hospital", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 16), new java.awt.Color(105, 138, 140))); // NOI18N

        jButton1.setText("Profissionais de saúde");

        jButton2.setText("Equipamentos");

        jButton3.setText("Pacientes");

        jButton4.setText("Enfermarias");
