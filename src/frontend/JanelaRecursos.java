...
public class JanelaRecursos extends javax.swing.JFrame {
    private Sistema sistema;
    
    public JanelaRecursos(Sistema sistema) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Recursos do hospital", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 16), new java.awt.Color(105, 138, 140))); // NOI18N

        jLabel1.setText("Percentagem de doentes em estado grave:");

        jLabel2.setText("Percentagem de equipamentos ocupados:");

        jLabel3.setText("Percentagem de doentes em estado muito grave:");

        jLabel4.setText("*Tipo 1*:");

        jLabel5.setText("*Tipo 3*:");

        jLabel6.setText("*Tipo 2*:");

        jLabel7.setText("Enfermaria com maior número de camas ocupadas:");

        jLabel8.setText("Enfermaria com menor número de equipamentos livres:");
